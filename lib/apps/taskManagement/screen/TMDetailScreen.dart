      ...
      appBar: appBarWidget(
        ...
        actions: [
          Container(
            ...
            height: 50,
            child:
                Image.asset('images/toDoList/profile.png', fit: BoxFit.cover),
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            16.height,
            noteDetailData(context,
                title: 'Place',
                name: widget.data!.place.validate(),
            ...
            noteDetailData(
              ...
              timeWidget: Row(
                children: [
                  Text('Starts: ${widget.data!.startTime}',
                      style: boldTextStyle()),
                  16.width,
                  Text('Ends: ${widget.data!.endTime.validate()}',
                      style: boldTextStyle()),
                ],
              ),
            ),
            noteDetailData(context,
                ...
                title: 'Notes',
                name: widget.data!.notes),
            noteDetailData(context,
                title: 'Priority',
                name: widget.data!.priority,
                img: 'images/toDoList/tm_flag.png'),
            noteDetailData(context,
                name: widget.data!.calender,
                title: "Calender",
