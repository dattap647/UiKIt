...
class TMAddNoteScreenState extends State<TMAddNoteScreen> {
  ...
  TimeRangeValue? datePicker = TimeRangeValue.value(
          ...
          child: Column(
            ...
            children: [
              ...
              addAndEditNotesWidget(
                ...
                noteWidget: AppTextField(
                  ...
                  decoration: InputDecoration(
                    focusedBorder: UnderlineInputBorder(
                        borderSide:
                            BorderSide(color: context.scaffoldBackgroundColor)),
                    enabledBorder: UnderlineInputBorder(
                        borderSide:
                            BorderSide(color: context.scaffoldBackgroundColor)),
                  ),
              ...
              addAndEditNotesWidget(
                ...
                noteWidget: Row(
                  children: [
                    Text('Starts : ${_timeFormated(datePicker!.startTime!)}',
                        style: boldTextStyle()),
                    16.width,
                    Text('Ends : ${_timeFormated(datePicker!.endTime!)}',
                        style: boldTextStyle()),
                  ],
                ),
              ).onTap(
                () {
                  TimeRangePicker.show(
                    ...
                    startTime: TimeOfDay(
                        hour: datePicker!.startTime!.hour,
                        minute: datePicker!.startTime!.minute),
                    endTime: TimeOfDay(
                        hour: datePicker!.endTime!.hour,
                        minute: datePicker!.endTime!.minute),
              ...
              tmButton(
                ...
                color: white,
                onTap: () async {
                  if (addTitleCont.text.isEmpty ||
                      addNoteCont.text.isEmpty ||
                      addPlaceCont.text.isEmpty) {
