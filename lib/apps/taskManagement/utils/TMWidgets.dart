...
Widget placeHolderWidget(
    ...
    AlignmentGeometry? alignment,
    double? radius}) {
  return Image.asset(tm_placeholder,
          height: height,
          width: width,
...
Widget socialButton(BuildContext context,
    {String? image, String? socialTitle, Color? color, Color? textColor}) {
  return AppButton(
    width: context.width(),
    ...
    child: Row(
      ...
      children: [
        commonCachedNetworkImage(image,
...
Widget noteLeadingWidget(BuildContext context,
    {required String image, Color? color}) {
  return Container(
    padding: EdgeInsets.all(16),
    decoration:
        boxDecorationDefault(shape: BoxShape.circle, color: context.cardColor),
    child: Image.asset(image.validate(),
        height: 20, width: 20, fit: BoxFit.cover, color: color),
  );
}

Widget noteDetailData(BuildContext context,
    {String? name,
    String? img,
    Widget? timeWidget,
    bool? isCheck = false,
...
Widget noteSearchIcon(BuildContext context,
    {String? searchImage, Color? color}) {
  return Container(
    padding: EdgeInsets.all(10),
    decoration: boxDecorationDefault(shape: BoxShape.circle),
    child: Image.asset(searchImage.validate(),
        color: context.iconColor, height: 16, width: 16),
  );
}

Widget addAndEditNotesWidget(BuildContext context,
    {Widget? noteWidget,
    String? img,
    String? title,
    Color? color,
...
Widget addAndEditNotesDescriptionWidget(BuildContext context,
    {String? img, Widget? widget}) {
  return Row(
    crossAxisAlignment: CrossAxisAlignment.center,
...
Widget noteCheckWidget(BuildContext context,
    {Color? color, Color? checkIconColor, Function()? onTap}) {
  return Container(
