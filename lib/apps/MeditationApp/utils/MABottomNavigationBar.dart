        ...
        children: <Widget>[
            ...
            child: Center(
              child: Transform.translate(
                ...
                child: Material(
                  ...
                  elevation: 4,
                  child: Padding(padding: const EdgeInsets.all(12.0), child: _icon),
                ),
              ),
            ),
          ),
          ...
          Align(
            ...
            child: Row(
              ...
              return NavButton(onTap: _buttonTap, position: _pos, length: _length, index: widget.items.indexOf(item), child: item);
            }).toList()),
          ),
        ],
      ),
