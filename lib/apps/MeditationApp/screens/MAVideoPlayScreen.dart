...
class MAVideoPlayScreen extends StatefulWidget {
  static String tag = '/VideoPlayScreen';
  final String url;

  MAVideoPlayScreen(this.url);

  @override
  MAVideoPlayScreenState createState() => MAVideoPlayScreenState();
}

class MAVideoPlayScreenState extends State<MAVideoPlayScreen> {
          ...
          AspectRatio(
            ...
            child: Stack(
              ...
              children: <Widget>[
                ...
                CircularProgressIndicator().visible(isBuffering)
              ],
            ),
          ).center(),
          SafeArea(
