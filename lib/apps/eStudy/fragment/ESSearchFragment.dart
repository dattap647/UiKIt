    ...
    return Container(
      ...
      child: AppTextField(
        ...
        decoration: InputDecoration(
          fillColor:
              appStore.isDarkModeOn ? context.cardColor : Colors.grey.shade100,
      ...
      itemBuilder: (_, i) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              cachedImage(list_degree[i].image.validate(),
                  width: 150, height: 100, fit: BoxFit.cover),
              8.height,
              Text(list_degree[i].title.validate(), style: primaryTextStyle()),
              Text(list_degree[i].subTitle.validate(),
                  style: primaryTextStyle(color: grey)),
            ],
          ),
        ).onTap(() {
          ESCourseScreen(
                  img: list_degree[i].image, name: list_degree[i].subTitle)
              .launch(context);
    ...
    return HorizontalList(
      ...
      itemBuilder: (_, i) {
        return Stack(
          ...
          children: [
            Container(
              ...
              decoration: boxDecorationRoundedWithShadow(8,
                  backgroundColor: list_degree[i].color!),
            ),
            cachedImage(list_degree[i].image.validate(),
                width: 280, height: 200, fit: BoxFit.cover),
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(list_degree[i].title.validate(),
          ...
          () {
            ESCourseScreen(
                    img: list_degree[i].image, name: list_degree[i].title)
                .launch(context);
          },
        );
      },
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              16.height,
              dashboardLabelsAndWASeeAll('Add Skill')
                  .paddingSymmetric(horizontal: 16),
              8.height,
              addTextField('eg. Photoshop , illustrator etc.'),
              16.height,
              dashboardLabelsAndWASeeAll('Add Interest')
                  .paddingSymmetric(horizontal: 16),
              8.height,
              ...
              dashboardLabelsAndSeeAll(
                ...
                onTap: () {
                  ...
                  ESCoursesViewAllScreen(list_degree: list_degree)
                      .launch(context);
                },
              ).paddingSymmetric(horizontal: 16),
              8.height,
