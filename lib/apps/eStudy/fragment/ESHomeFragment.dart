      ...
      child: Scaffold(
                ...
                SettingItemWidget(
                  ...
                  trailing: IconButton(
                    icon: Icon(MaterialCommunityIcons.bell_outline,
                        size: 24, color: grey),
                    onPressed: () {
                      ESNotificationScreen().launch(context,
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              16.height,
              Text('Categories', style: primaryTextStyle())
                  .paddingSymmetric(horizontal: 16),
              categoryListWidget(),
              8.height,
              dashboardLabelsAndSeeAll(
                ...
                onTap: () {
                  ESDegreeViewAllScreen(list_degree: list_degree)
                      .launch(context);
                },
              ).paddingSymmetric(horizontal: 16),
              degreeListWidget(),
              ...
              dashboardLabelsAndSeeAll(
                ...
                onTap: () {
                  ESTopCoursesViewAllScreen(list_degree: list_degree)
                      .launch(context);
                },
              ).paddingSymmetric(horizontal: 16),
              8.height,
