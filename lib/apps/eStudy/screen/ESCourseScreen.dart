  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
        ...
        children: [
          cachedImage(widget.img.validate(),
              width: context.width(), height: 320, fit: BoxFit.cover),
              ...
              children: [
                          ...
                          (index) {
                            ...
                            return Container(
                              ...
                              child: SettingItemWidget(
                                ...
                                titleTextStyle:
                                    boldTextStyle(color: ESSecondaryColor),
                                subTitle: '1:48',
                                subTitleTextStyle: secondaryTextStyle(),
                                leading: Text('0' + label.toString(),
                                    style: boldTextStyle(size: 20)),
                                trailing: Icon(Icons.play_circle_outline,
                                    size: 40, color: ESSecondaryColor),
                              ),
                            );
                          },
                        ),
                        ...
                        children: instructorData.map(
                          (e) {
                            return SettingItemWidget(
                              ...
                              subTitle: 'Professor',
                              subTitleTextStyle: secondaryTextStyle(),
                              leading: cachedImage(e.image.validate(),
                                      height: 50, width: 50)
                                ...
                                children: [
                                  IconButton(
                                    icon: Icon(Icons.call,
                                        size: 16, color: ESSecondaryColor),
                                    onPressed: () {
                                      //
                                    },
                                  ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    cachedImage(
                                            studentData[index].image.validate(),
                                            height: 45,
                                            width: 45)
                                        .cornerRadiusWithClipRRect(25),
                                    8.width,
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                            studentData[index].title.validate(),
                                            style: boldTextStyle()),
                                        Row(
                                          children: [
                                            Text('4.8',
                                ...
                                8.height,
                                Text(firstHalf.validate(),
                                    style: primaryTextStyle(), maxLines: 5)
                              ],
                            ),
                          );
                        },
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child:
                        Icon(Icons.play_arrow_outlined, color: white, size: 20),
                  ),
                ),
              ],
            ),
