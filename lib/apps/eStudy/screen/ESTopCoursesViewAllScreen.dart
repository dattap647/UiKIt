...
class ESTopCoursesViewAllScreen extends StatefulWidget {
  ...
  @override
  ESTopCoursesViewAllScreenState createState() =>
      ESTopCoursesViewAllScreenState();
}
      ...
      appBar: appBarWidget(
        ...
        backWidget: IconButton(
          ...
          icon: Icon(Icons.arrow_back_ios,
              color: appStore.isDarkModeOn ? white : black, size: 18),
        ),
        elevation: 0,
      ),
        ...
        child: Wrap(
          ...
          children: List.generate(
            ...
            (i) => Stack(
              ...
              children: [
                Container(
                  ...
                  decoration: boxDecorationRoundedWithShadow(8,
                      backgroundColor: widget.list_degree![i].color!),
                ),
                cachedImage(widget.list_degree![i].image.validate(),
                        width: context.width() * 0.48 - 17,
                        height: 180,
                        fit: BoxFit.cover)
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(widget.list_degree![i].title.validate(),
                          style: primaryTextStyle(color: white)),
                      Text(widget.list_degree![i].subTitle.validate(),
              ...
              () {
                ESCourseScreen(
                        img: widget.list_degree![i].image,
                        name: widget.list_degree![i].title)
                    .launch(context);
              },
            ),
          ),
