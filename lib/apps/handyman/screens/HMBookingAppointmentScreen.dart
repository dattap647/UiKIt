...
class HMBookingAppointmentScreen extends StatefulWidget {
  ...
  @override
  HMBookingAppointmentScreenState createState() =>
      HMBookingAppointmentScreenState();
}

class HMBookingAppointmentScreenState
    extends State<HMBookingAppointmentScreen> {
          ...
          child: Column(
            children: [
              createRichText(list: [
                TextSpan(
                    text: "Total Price : ",
                    style: boldTextStyle(color: HMFontColor400)),
                TextSpan(
                    text: "\$45", style: boldTextStyle(color: hmColorPrimary)),
              ]),
              8.height,
              Text("Steps ${pageIndex + 1} / 10",
                  style: TextStyle(color: HMFontColor400)),
              8.height
            ],
          ),
        ),
