          ...
          child: Column(
            children: [
                                ...
                                createRichText(
                                  list: [
                                    TextSpan(
                                        text: "Hey, ",
                                        style: boldTextStyle(
                                            size: 16, color: HMFontColor400)),
                                    TextSpan(
                                        text: "Selena",
                                        style: TextStyle(color: HMColorWhite)),
                                  ],
                                ).paddingLeft(16),
                                16.height,
              ...
              Container(
                child: Row(
                  ...
                  children: [
                    ...
                    Text("View All",
                            style: boldTextStyle(color: hmColorPrimary))
                        .onTap(() {
                      HMAllCategoryData().launch(context);
                    })
                  ],
              ...
              CommonCategoryContainer(
                  ...
                  appBarTitle: 'Recommended for You'),
              Container(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("Moving into a New Home",
              ...
              CommonSubCategoryContainer(
                  categoryData: moveHomeList,
                  appBarTitle: 'Moving into a New home'),
              Container(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    Text("View All",
                            style: boldTextStyle(color: hmColorPrimary))
                        .onTap(() {
                      HMAllCategoryData(appBarTitle: "Essential Home Services")
                          .launch(context);
                    }),
                  ],
                ),
              ...
              CommonSubCategoryContainer(
                  categoryData: essentialServiceList,
                  appBarTitle: 'Essential Home Services'),
              Container(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
              ...
              CommonSubCategoryContainer(
                  categoryData: outdoorUpkeepList,
                  appBarTitle: 'Outdoor Upkeep')
            ],
          ).paddingBottom(16),
        ),
      ),
