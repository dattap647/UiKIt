          ...
          child: Column(
            children: [
              Container(
                ...
                children: [
                  Text("Sign Up",
                      style: boldTextStyle(size: HMHeadingFontSize.toInt())),
                  Text("Please write your information below",
                          style: TextStyle(
                              color: HMFontColor600, fontSize: HMFontSize))
                      .paddingTop(18.0),
                  Container(
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            onTap: () async {
                              ...
                              if (_dobDate != null &&
                                  _dobDate != DateTime.now()) {
                                _dobController!.text = '${_dobDate!.year}/' +
                                    '${_dobDate!.month}/' +
                                    '${_dobDate!.day}';
                              }
                            },
                            ...
                            decoration: InputDecoration(
                              suffixIcon: GestureDetector(
                                  onTap: () {},
                                  child:
                                      Icon(Icons.calendar_today, color: gray)),
                              border: InputBorder.none,
              ...
              Container(
                ...
                TextSpan(
                    ...
                    style: TextStyle(color: HMFontColor600)),
                TextSpan(
                    text: "Sign In",
            ...
            top: HMAppPadding, left: HMAppPadding, right: HMAppPadding),
      ),
    );
  }
}
