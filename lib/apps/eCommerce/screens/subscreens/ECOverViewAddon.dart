      ...
      child: Stack(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(color: appStore.isDarkModeOn ? cardDarkColor : white, borderRadius: radius(ecDefaultRadius2)),
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    commonCacheImageWidget(ec_shoes2, 80, width: 80, fit: BoxFit.cover).cornerRadiusWithClipRRect(16),
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        8.height,
                        Text('\$1267', style: boldTextStyle(color: appStore.isDarkModeOn ? white : darkBlue)),
                        4.height,
                ...
                HorizontalList(
                  ...
                  itemBuilder: (context, index) {
                    return Container(margin: EdgeInsets.only(right: 8), child: Icon(Icons.circle, size: 25, color: itemColor[index]));
                  },
                ),
                8.height,
                ...
                HorizontalList(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      child: Text(availableSize[index], style: primaryTextStyle(color: black)),
                      padding: EdgeInsets.all(8),
                      margin: EdgeInsets.only(right: 8),
                      decoration: boxDecorationWithShadow(
                        borderRadius: BorderRadius.circular(8),
                        boxShadow: defaultBoxShadow(),
                        backgroundColor: selectedSize == index ? lightBlue : white,
                      ),
                    ).onTap(() {
                      setState(() {
                        selectedSize = index;
                ...
                Row(
                  children: [
                    ...
                    Container(
                      ...
                      width: 100,
                      decoration: BoxDecoration(borderRadius: radius(ecDefaultRadius1), color: Colors.grey[300]),
                      child: Text('$counter', style: primaryTextStyle(color: appStore.isDarkModeOn ? scaffoldDarkColor : black)),
                    ),
                    20.width,
                    AppButton(
                      width: 30,
