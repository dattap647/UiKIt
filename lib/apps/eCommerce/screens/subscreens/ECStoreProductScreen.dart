                  ...
                  child: Stack(
                    ...
                    children: [
                      Container(
                        ...
                        child: Row(
                          children: [
                            commonCachedNetworkImage(data.img!, width: 80, fit: BoxFit.cover).cornerRadiusWithClipRRect(16),
                            16.width,
                            Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    4.width,
                                    Text('(${data.count} rating)', style: secondaryTextStyle()),
                                  ],
                                ),
                                Row(
                                  children: [
                                    Icon(Icons.shopping_cart_sharp, color: ec_lightRed),
                                    Text('${data.sales}k Sales', style: primaryTextStyle()),
                                  ],
                                ),
                                2.height,
                                Row(
                                  children: [
                                    Text('\$${data.price}', style: boldTextStyle(color: appStore.isDarkModeOn ? white : darkBlue)),
                                    20.width,
                                    Text('-${data.discount}%', style: secondaryTextStyle()),
                                  ],
                                ),
                              ],
                            ),
                      ...
                      Positioned(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Text('${data.no}', style: boldTextStyle(color: appStore.isDarkModeOn ? cardDarkColor : white)),
                          ],
                        ),
                      ),
                    ],
