...
class ECHomeFragmentState extends State<ECHomeFragment> {
  ...
  void dispose() {
    ...
    super.dispose();
    setStatusBarColor(appStore.isDarkModeOn ? scaffoldDarkColor : white,
                    ...
                    children: [
                          ...
                          Row(
                            children: [
                              Container(
                                  ...
                                  child: commonCachedNetworkImage(ec_logo,
                                          width: 45,
                                          height: 45,
                                          fit: BoxFit.cover)
                            ...
                            children: [
                              IconButton(
                                icon: Icon(Feather.shopping_bag,
                                    color: white, size: ecIconSize.toDouble()),
                                onPressed: () {
                                  ECProductTabBarPage().launch(context);
                                },
                              ),
                              IconButton(
                                icon: Icon(Fontisto.bell,
                                    color: white, size: ecIconSize.toDouble()),
                                onPressed: () {
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            borderRadius:
                                BorderRadius.circular(ecDefaultRadius1),
                            color:
                          ...
                          return InkWell(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                4.height,
                                Text(e.name!, style: boldTextStyle(size: 14))
                                    .expand(),
                              ],
                            ),
                          );
