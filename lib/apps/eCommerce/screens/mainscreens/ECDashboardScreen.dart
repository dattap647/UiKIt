                  ...
                  return Stack(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(color: appStore.isDarkModeOn ? cardDarkColor : white, borderRadius: BorderRadius.circular(30)),
                        child: SingleChildScrollView(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              commonCachedNetworkImage(ec_barcode, fit: BoxFit.cover, height: 110, width: 110).cornerRadiusWithClipRRect(50),
                              16.height,
                              Text('Scan Product', style: boldTextStyle(size: 20)),
                              16.height,
                              Text(
                              ...
                              RichText(
                                text: TextSpan(
                                  text: 'By continuing to use the camera in app or by submitting images, you agree to the ',
                                  style: primaryTextStyle(fontFamily: 'Poppins'),
                                  children: <TextSpan>[
                                    TextSpan(
                                      text: ' Condition of use ',
                                      style: primaryTextStyle(color: darkSlateBlue, fontFamily: 'Poppins'),
                                      recognizer: TapGestureRecognizer()
                                        ..onTap = () {
                                          ECConditionScreen().launch(context);
                                        },
                                    ),
                                    TextSpan(text: ' and to text processing.', style: primaryTextStyle(fontFamily: 'Poppins')),
                                  ],
                                ),
                              ),
                              8.height,
                              RichText(
                                text: TextSpan(
                                  text: 'Image related to your use of the camera in the app. Your submitted images and other related information to provide and improve its service.\nPlease see our',
                                  style: primaryTextStyle(fontFamily: 'Poppins'),
                                  children: <TextSpan>[
                                    TextSpan(
                                      text: ' Privacy Notice ',
                                      style: primaryTextStyle(color: darkSlateBlue),
                                      recognizer: TapGestureRecognizer()
                                        ..onTap = () {
                                          ECConditionScreen().launch(context);
                                        },
                      ...
                      Positioned(
                        ...
                        child: Container(
                          ...
                          decoration: boxDecorationWithShadow(borderRadius: BorderRadius.circular(8), backgroundColor: appStore.isDarkModeOn ? cardDarkColor : white),
          ...
          items: [
            ...
            BottomNavigationBarItem(
              ...
              icon: Container(
                height: 50,
                width: 50,
                decoration: BoxDecoration(color: Colors.blue, borderRadius: BorderRadius.circular(ecDefaultRadius1)),
                child: Icon(Icons.qr_code_scanner_outlined, color: white),
              ),
            ),
            BottomNavigationBarItem(icon: Icon(Icons.wallet_giftcard), label: 'Promo'),
