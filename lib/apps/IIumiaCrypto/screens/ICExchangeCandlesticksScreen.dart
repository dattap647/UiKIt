        ...
        children: [
          ...
          Row(
            children: [
              ...
              4.width,
              Text("+0.69(1%)", style: secondaryTextStyle(color: icSkip)),
            ],
          ...
          Row(
            ...
            children: [
              Container(
                ...
                height: 30,
                decoration: BoxDecoration(borderRadius: radius(8), color: icNavyBlueColor),
              ...
              Row(
                children: [
                  Text("\$98339.8", style: TextStyle(color: icWhiteColor, fontSize: 20, fontWeight: FontWeight.bold)),
                  4.width,
                  Text("+3.49%", style: secondaryTextStyle(color: icSkip)),
                ],
              ),
            ],
          ),
            ...
            children: List.generate(
              ...
              (index) {
                ...
                return Container(
                  ...
                  child: Text('${data.head}', style: secondaryTextStyle(color: icWhiteColor, size: 10)),
                ).onTap(
                  () {
                    selected = index;
                    setState(() {});
