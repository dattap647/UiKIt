  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
              icon: Icon(like ? Icons.bookmark_border_outlined : Icons.bookmark, color: icWhiteColor, size: 20),
              onPressed: () {
                like = !like;
                setState(() {});
              }),
          IconButton(icon: Icon(Icons.search_outlined, color: icWhiteColor, size: 20), onPressed: () {}),
        ],
      ),
      backgroundColor: icScaffoldBgColor,
                        ...
                        child: Column(
                          children: [
                            Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text('in Bitcoin eExchange ', style: TextStyle(color: icSkip, fontSize: 15)),
                                    4.height,
                                    Text('by Jackii Sparrow ', style: TextStyle(color: icWhiteColor, fontSize: 15)),
                                  ],
                                )
                              ],
                            ),
                            ...
                            Text(
                              ...
                              style: boldTextStyle(color: icWhiteColor, size: 15),
                            ),
                          ],
                        ),
                      );
                  ...
                  return Row(
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text('${e.pText}', style: boldTextStyle(color: icWhiteColor)),
                          4.height,
                          Text('${e.secText}', style: secondaryTextStyle(color: icWhiteColor, size: 10)),
                          4.height,
                          Text('${e.thirdText}', style: secondaryTextStyle(color: icSkip, size: 10)),
                          4.height,
                          Text('${e.forthText}', style: secondaryTextStyle(color: icWhiteColor, size: 12), maxLines: 2, overflow: TextOverflow.ellipsis)
                        ],
                      ).expand(),
                    ],
                  ).paddingAll(8).onTap(
