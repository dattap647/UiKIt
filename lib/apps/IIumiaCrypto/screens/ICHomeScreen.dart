                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            IconButton(icon: Icon(Icons.music_note_outlined, color: icWhiteColor, size: 20), onPressed: () {}),
                    ...
                    16.height,
                    Text('Good Morning', style: secondaryTextStyle(color: icWhiteColor)),
                    Text('Richard', style: boldTextStyle(color: icWhiteColor, size: 28)),
                    8.height,
                    Container(
                      width: context.width(),
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('Total Portfolio Value', style: secondaryTextStyle(color: icWhiteColor)),
                          8.height,
                          Text(' \$ 4,409.98', style: TextStyle(color: icWhiteColor, fontSize: 32)),
                          8.height,
                          RichText(
                            text: TextSpan(
                              text: '+\$324.87',
                              style: secondaryTextStyle(color: icSkip),
                              children: <TextSpan>[
                                TextSpan(text: ' last month', style: secondaryTextStyle(color: icWhiteColor)),
                              ],
                            ),
                          )
                        ],
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  4.width,
                                  Text('${e.head}', style: secondaryTextStyle(color: icWhiteColor)),
                                ],
                              ),
                              8.height,
                              RichText(
                                text: TextSpan(
                                  text: '${e.pFig}',
                                  style: TextStyle(color: icWhiteColor, fontWeight: FontWeight.bold, fontSize: 26),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${e.subtext}",
                                        style: secondaryTextStyle(color: icSecTextColor, size: 10),
                                      )
                                    ],
                                  )
                                ],
                              ),
                              Text("${e.fig}", style: primaryTextStyle(color: icWhiteColor)),
                            ],
                          ).paddingAll(8).onTap(() {
                            ICActivityScreen().launch(context);
                          });
