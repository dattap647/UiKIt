  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(like ? Icons.bookmark_border_outlined : Icons.bookmark,
                color: icWhiteColor, size: 20),
            onPressed: () {
              like = !like;
              setState(() {});
            },
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Column(
              children: [
                Text(widget.data!.pText!,
                    style: boldTextStyle(color: icWhiteColor, size: 18)),
                16.height,
                Row(
                  children: [
                    Icon(Icons.calendar_today_outlined,
                        color: icWhiteColor, size: 18),
                    8.width,
                    Text(widget.data!.secText!,
                        style:
                            secondaryTextStyle(color: icWhiteColor, size: 15)),
                  ],
                ),
                16.height,
                Row(
