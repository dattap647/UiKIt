      ...
      body: Form(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text('Enter your Code', style: TextStyle(color: icWhiteColor, fontSize: 24, fontWeight: FontWeight.bold)),
              8.height,
              Text(
              ...
              8.height,
              Text(widget.mobileNo, style: TextStyle(color: icSkip)),
              30.height,
              Form(
                child: Row(
                  ...
                  children: [
                    Container(
                      width: 60,
                      height: 55,
                      decoration: BoxDecoration(color: icNavyBlueColor),
                      child: TextFormField(
                        focusNode: pin1FocusNode,
              ...
              Align(
                ...
                child: Text.rich(
                  TextSpan(
                    ...
                    style: secondaryTextStyle(size: 14, color: icWhiteColor),
                    children: <TextSpan>[
              ...
              TextButton(onPressed: () {}, child: Text("Resend Link", style: TextStyle(color: icSkip))).center(),
              32.height,
              SizedBox(
                height: 45,
