          ...
          children: settingsList.map(
            (e) {
              return SettingItemWidget(
                ...
                leading: Container(decoration: boxDecorationDefault(color: icNavyBlueColor), padding: EdgeInsets.all(8), child: e.i),
                trailing: Icon(Icons.arrow_forward_ios_outlined, color: icWhiteColor, size: 16),
                onTap: () {
                  if (e.screen == null) {
