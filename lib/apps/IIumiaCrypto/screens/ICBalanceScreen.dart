          ...
          children: [
            Row(
              ...
              children: [
                Container(
                  height: 30,
                  child: Text("USD", style: secondaryTextStyle(color: icSecTextColor), textAlign: TextAlign.start),
                ),
                8.width,
                Text('26 421.03', style: boldTextStyle(color: icWhiteColor, size: 30)),
            ...
            Row(
              ...
              children: [
                ...
                8.width,
                Text("\$241 (13%) today", style: secondaryTextStyle(color: icSecTextColor)),
              ],
            ),
            16.height,
            Container(
              ...
              child: Column(
                children: [
                      ...
                      Container(
                        ...
                        child: DropdownButton(
                          ...
                          items: dropdownItems.map((e) {
                            return DropdownMenuItem(child: Text(e, style: TextStyle(color: icWhiteColor, fontSize: 10)), value: e);
                          }).toList(),
                          underline: SizedBox(),
                        ),
                      ),
                  ...
                  Container(
                    ...
                    child: Text("+\$168(5%)", style: primaryTextStyle(color: icWhiteColor)),
                  ),
                  8.height,
                  Container(
                    height: 150,
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              4.height,
                              Text("${e.sec}", style: secondaryTextStyle(color: icSecTextColor, size: 10)),
                            ],
                          ),
                        ],
                      ),
                      Row(
                        children: [
                          ...
                          8.width,
                          Icon(Icons.arrow_drop_down, color: icWhiteColor),
                        ],
                      )
                    ],
                  ),
