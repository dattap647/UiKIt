                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                8.width,
                                Text('Venture capital card', style: boldTextStyle(color: icWhiteColor)),
                              ],
                            ),
                            IconButton(icon: Icon(Icons.more_vert, color: icWhiteColor, size: 30), onPressed: () {})
                          ],
                        ),
                        Text('4916   9091   8053    9956', style: TextStyle(color: icWhiteColor, fontSize: 15)),
                        16.height,
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Card Holder', style: secondaryTextStyle(color: icSecTextColor)),
                                8.height,
                                Text('Harinder Bharwal', style: boldTextStyle(color: icWhiteColor)),
                              ],
                            ),
                ...
                return Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('${e.fig}  ', style: boldTextStyle(color: icWhiteColor, size: 20))
                    ],
                  ),
                );
              },
