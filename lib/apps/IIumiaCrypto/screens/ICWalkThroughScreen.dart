...
class _ICWalkThroughScreenState extends State<ICWalkThroughScreen> {
  ...
  void initState() {
    a.add(ICInitialSlider(
        ptitle: 'Management Wallet', color: icScaffoldBgColor, stext: 'Store and manage all your digital curriences with ease in the smart wallet interface', img: 'images/iiumiaCrypto/ic_pgv1.png'));
    a.add(ICInitialSlider(
    ...
    a.add(ICInitialSlider(
        ptitle: 'Safe & Security', color: icScaffoldBgColor, stext: 'Chenge your cryptocurrency to another Digital assets or flat memory safely , reliably', img: 'images/iiumiaCrypto/ic_pgv3.png'));
    a.add(ICInitialSlider(
        ptitle: 'Keep it organized', color: icScaffoldBgColor, stext: 'Buy and sell Bitcoin, other crypto currency with VISA and MasterCard right in the app', img: 'images/iiumiaCrypto/ic_pgv4.png'));
        ...
        children: [
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      30.height,
                      Text('${e.ptitle}', style: boldTextStyle(color: icWhiteColor, size: 20), textAlign: TextAlign.center),
                      SizedBox(height: 16),
                      Text('${e.stext}', style: secondaryTextStyle(color: icWhiteColor), textAlign: TextAlign.center).paddingAll(16)
                    ],
                  ),
                );
              },
          ...
          Align(
            ...
            child: TextButton(
                ...
                child: Text('Skip', style: boldTextStyle(color: icSkip))),
          ).paddingOnly(top: 18),
