        ...
        child: Column(
          children: [
            ...
            Container(
              height: 150,
              width: 150,
              child: Text("\$ 1545.4", style: boldTextStyle(color: icWhiteColor, size: 25)).center(),
              decoration: BoxDecoration(border: Border.all(width: 8, color: Colors.blue), color: icScaffoldBgColor, borderRadius: radius(100)),
            ).center(),
            16.height,
            Wrap(
              spacing: 4,
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                4.height,
                                Text("42%", style: secondaryTextStyle(color: icSecTextColor, size: 10)),
                              ],
                            ),
                          ],
                        ),
