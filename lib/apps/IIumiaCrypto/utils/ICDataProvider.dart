...
List<ICDashBoardList> getDashBoradList() {
  ...
  list.add(ICDashBoardList(i: Icon(Icons.paste_outlined, color: icSkip), head: "Report", screen: ICReportScreen()));
  list.add(
...
List<ICRevenueList2> getRevenueList2() {
  ...
  list.add(ICRevenueList2(i: "images/iiumiaCrypto/ic_eth.png", ic: Icon(Icons.trending_up, color: Colors.blue), c: icSkip));
  list.add(ICRevenueList2(i: "images/iiumiaCrypto/ic_dash.png", ic: Icon(Icons.trending_up, color: Colors.blue), c: icSkip));
  list.add(ICRevenueList2(i: "images/iiumiaCrypto/ic_bitcoin.png", ic: Icon(Icons.trending_up, color: Colors.blue), c: icSkip));
  list.add(ICRevenueList2(i: "images/iiumiaCrypto/ic_bitcoin.png", ic: Icon(Icons.trending_up, color: Colors.blue), c: icSkip));
...
List<ICTransactionHistoryList> getTransactionHistoryList() {
  ...
  list.add(ICTransactionHistoryList(img: "images/iiumiaCrypto/ic_waveCoin.png", head: "Wave coin", secStr: "26/07/2019", fig: "+0.001 BTC", c: icSkip));
  ...
  list.add(ICTransactionHistoryList(img: "images/iiumiaCrypto/ic_bitcoin.png", head: "Bitcoin", secStr: "26/07/2019", fig: "+0.001 BTC", c: icSkip));
...
List<ICAddCardList> getAddCardList() {
  ...
  list.add(ICAddCardList(
      img: Container(
        ...
        decoration: boxDecorationDefault(color: icWhiteColor, borderRadius: radius()),
      ),
      pText: 'Master Card',
      secText: '26.07.2019'));
  list.add(ICAddCardList(
