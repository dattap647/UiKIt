...
class FDFavouriteStoreNextScreen extends StatefulWidget {
  ...
  @override
  FDFavouriteStoreNextScreenState createState() =>
      FDFavouriteStoreNextScreenState();
}

class FDFavouriteStoreNextScreenState
    extends State<FDFavouriteStoreNextScreen> {
  @override
  void initState() {
    super.initState();
    init();
            ...
            return [
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background:
                      Image.asset(widget.image!, height: 200, fit: BoxFit.fill),
                ),
                leading:
