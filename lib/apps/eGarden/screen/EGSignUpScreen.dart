          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                createRichText(list: [
                  TextSpan(
                      text: "Enter your email and password for sign up or ",
                ...
                TextFormField(
                  ...
                  onChanged: (val) {
                    ...
                    isSignUpBtnEnable = emailCtrl.text.isEmptyOrNull ||
                            !isValidEmail ||
                            passCtrl.text.isEmptyOrNull ||
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintStyle: secondaryTextStyle(),
                    labelStyle: secondaryTextStyle(size: 16),
                    enabledBorder: isCPasswordIconVisible
                        ? UnderlineInputBorder(
                            borderSide: BorderSide(color: gray, width: 1.5))
                        : UnderlineInputBorder(
                            borderSide: BorderSide(color: gray, width: 1.5)),
                  ...
                  onChanged: (val) {
                    isPasswordMatch =
                        passCtrl.text == cPassCtrl.text ? true : false;
