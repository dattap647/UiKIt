      ...
      itemBuilder: (context, index) {
        ...
        return Container(
          ...
          child: Stack(
            ...
            children: [
              Container(
                  height: 60, color: dataModel.lightColor!.withOpacity(0.4)),
              commonCacheImageWidget(dataModel.image, 130)
                  .paddingSymmetric(vertical: 20),
              Column(
                children: [
                  6.height,
                  Text(dataModel.title!.toUpperCase(),
                      style: boldTextStyle(color: dataModel.textColor)),
                  2.height,
                  Text(dataModel.subtitle!.toUpperCase(),
        ...
        child: Stack(
          children: [
            Transform.rotate(
              ...
              angle: 2.0,
              child: Container(
                  height: 150, color: dataModel.lightColor!.withOpacity(0.3)),
            ),
            Align(
                alignment: Alignment.topCenter,
                child: commonCacheImageWidget(dataModel.image, 130)
            ...
            Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text("\$${dataModel.price}",
                      style:
                          boldTextStyle(size: 12, color: dataModel.darkColor)),
                ),
              ],
            ).paddingAll(12),
          ],
...
Widget roundedButtonWithoutFillColor(
    {required BuildContext context, required String btnText}) {
  return Container(
    ...
    decoration: boxDecorationWithRoundedCorners(
        border: Border.all(color: egPrimaryColor1),
        backgroundColor: transparentColor),
    child: Text(btnText,
        style: primaryTextStyle(color: egPrimaryColor1, size: 18)),
  );
}

Widget roundedButtonWithFillColor(
  ...
  return Container(
    ...
    alignment: Alignment.center,
    decoration: boxDecorationWithRoundedCorners(
        backgroundColor: isEnable ? egPrimaryColor1 : appPrimaryColor),
        ...
        return StatefulBuilder(
          builder: (context, state) {
            return AlertDialog(
              ...
              title: Row(
                children: [
                  Text("Light Customize", style: boldTextStyle(size: 20))
                      .center()
                      .expand(),
                  IconButton(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                              "Recommend settings for your plant mode. Turn off to customize",
                  ...
                  Column(
                    ...
                    children: [
                        ...
                        child: CupertinoTheme(
                          data: CupertinoThemeData(
                              textTheme: CupertinoTextThemeData(
                                  dateTimePickerTextStyle: appStore.isDarkModeOn
                      ...
                      createRichText(list: [
                        ...
                        TextSpan(
                            text: "(nm)", style: secondaryTextStyle(size: 12)),
                      ]),
                      8.height,
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          SizedBox(
                              width: 50,
                              child:
                                  Text("Red", style: boldTextStyle(size: 14))),
                          Slider(
                            min: 0,
                      ...
                      Row(
                        ...
                        children: [
                          SizedBox(
                              width: 50,
                              child:
                                  Text("Blue", style: boldTextStyle(size: 14))),
                          Slider(
                            min: 0,
                      ...
                      Container(
                        ...
                        alignment: Alignment.center,
                        decoration: boxDecorationWithRoundedCorners(
                            backgroundColor: egPrimaryColor1),
                        child: Text("Save",
        ...
        return StatefulBuilder(
          builder: (context, state) {
            return AlertDialog(
              ...
              title: Row(
                children: [
                  Text("Water Customize", style: boldTextStyle(size: 20))
                      .center()
                      .expand(),
                  IconButton(
                      padding: EdgeInsets.zero,
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text("No",
                        style:
                            primaryTextStyle(color: egPrimaryColor1, size: 18)),
                  ).onTap(() {
        ...
        return StatefulBuilder(
          builder: (context, state) {
            return AlertDialog(
              ...
              title:
                  Text("Plant Name", style: boldTextStyle(size: 20)).center(),
              content: Wrap(
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: UnderlineInputBorder(
                          borderSide:
                              BorderSide(color: egPrimaryColor1, width: 1.5)),
                      enabledBorder: UnderlineInputBorder(
                          borderSide:
                              BorderSide(color: egPrimaryColor1, width: 1.5)),
                      contentPadding: EdgeInsets.zero,
                      labelStyle: secondaryTextStyle(size: 16),
                      suffixIcon: isOldName
                          ? IconButton(
        ...
        return StatefulBuilder(
          builder: (context, state) {
            return AlertDialog(
              ...
              content: Wrap(
                children: [
                  Text("Your $title is still very young!",
                      style: secondaryTextStyle(size: 14)),
                  Text("Are you sure want to finish plant?",
                          style: secondaryTextStyle(size: 14))
                      .paddingTop(4),
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
...
Widget btnWithoutFillColor({required String btnText}) {
  return Container(
    ...
    decoration: boxDecorationWithRoundedCorners(
        ...
        backgroundColor: transparentColor),
    child:
        Text(btnText, style: boldTextStyle(color: egPrimaryColor1, size: 18)),
  );
}
...
Widget btnWithFillColor({required String btnText}) {
  return Container(
    ...
    alignment: Alignment.center,
    decoration:
        boxDecorationWithRoundedCorners(backgroundColor: egPrimaryColor1),
...
Widget settingListWithSwitch(
    {Widget? trailing, required String title, String subtitle = ""}) {
  return Card(
    child: Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Transform.scale(
              alignment:
                  subtitle.isNotEmpty ? Alignment.topCenter : Alignment.center,
              scale: 0.75,
              child: trailing),
        ],
      ),
...
Widget settingListWithBoldTitle(
    {IconData? iconLeading, required String title, String? subtitle}) {
  return Card(
    child: Container(
        ...
        return StatefulBuilder(
          builder: (context, state) {
            return AlertDialog(
              ...
              insetPadding: EdgeInsets.all(48),
              titlePadding: EdgeInsets.only(top: 16),
              title: Text("Congratulations!", style: boldTextStyle(size: 20))
                  .center(),
              content: Wrap(
                children: [
