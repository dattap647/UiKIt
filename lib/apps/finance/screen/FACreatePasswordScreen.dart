        ...
        child: Column(
          ...
          children: [
            ...
            Align(
                ...
                child: Text('Create Password', style: boldTextStyle(size: 30))),
            8.height,
            Align(
                alignment: Alignment.topLeft,
                child: Text(fa_create_password_remember,
              ...
              child: Column(
                children: [
                  ...
                  createPasswordWidget(
                      title: "Has at least 8  characters",
                      iconColor: fa_color_green),
                  createPasswordWidget(
                      title: "Has an uppercase letter or symbol",
                      iconColor: fa_color_green),
                  createPasswordWidget(
                      title: "Has a number", iconColor: fa_color_green),
                ],
              ),
            )
          ],
