    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          30.height,
          Image.asset(fa_user2, height: 80, width: 80, fit: BoxFit.fill)
          ...
          Row(
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  createRichText(
                    list: [
                      TextSpan(
                          text: "Safe to spend:", style: primaryTextStyle()),
              ...
              Spacer(),
              Text('Change',
                  style: boldTextStyle(color: fa_color_secondary, size: 14)),
            ],
          ),
          8.height,
          Divider(),
          ...
          SliderButton(
            ...
            label: Text("Swipe to send money",
