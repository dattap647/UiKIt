      ...
      child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Column(children: [
              Text("Profile",
                      style: boldTextStyle(color: commonColorWhite, size: 26))
                  .center()
                  .paddingAll(16),
              CircleAvatar(
                backgroundColor: appPrimaryColor,
                child:
                    Icon(Icons.person, color: commonColorWhite, size: iconSize),
                radius: 60,
              ).onTap(() async {
                final pickImage =
              ...
              commonDataList(
                  ...
                  data: Text("Basic",
                      style: TextStyle(
                          color: commonColorWhite, fontSize: textSize))),
              AppButton(
                width: context.width(),
                height: 50,
                color: appPrimaryColor,
                child: Text("Upgrade",
                    style: boldTextStyle(color: commonColorWhite),
