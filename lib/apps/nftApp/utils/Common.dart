...
InputDecoration buildInputDecoration(
    {String? name, Widget? icon, Widget? suffixIcon}) {
...
Widget settingWidget(
    {String? name, IconData? icon, IconData? iconData, Function()? onTap}) {
  return InkWell(
    onTap: onTap,
    child: Padding(
...
appBar({bool isBack = false}) {
  return AppBar(
    ...
    iconTheme: IconThemeData(
        color: appStore.isDarkModeOn ? Colors.white70 : scaffoldColorDark),
    backgroundColor:
    ...
    title: Image.asset(
        appStore.isDarkModeOn
            ? 'images/nft/ic_app_logo_dark.png'
            : 'images/nft/ic_app_logo.png',
        fit: BoxFit.cover,
        width: 160),
  );
}
