...
class MBWalkThroughScreenState extends State<MBWalkThroughScreen>
    with AfterLayoutMixin<MBWalkThroughScreen> {
  ...
  void afterFirstLayout(BuildContext context) {
    pages = [
      Column(
        ...
        children: [
          Image.asset(mb_bank_logo, height: 200, fit: BoxFit.cover)
              .paddingOnly(top: 40),
          32.height,
      ...
      Column(
        children: [
          ...
          Text('Don\'t Worry about 3rd party\n Hacks. It is fast and secure',
              textAlign: TextAlign.center, style: secondaryTextStyle(size: 16)),
        ],
      ).paddingOnly(top: 60),
      Column(
        children: [
            ...
            child: Column(
              children: [
                AppButton(
                  ...
                  width: context.width(),
                  child: Text(
                      currentPage == 3 ? 'Let\'s create an account' : 'Next',
