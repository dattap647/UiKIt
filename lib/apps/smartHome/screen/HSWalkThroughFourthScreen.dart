...
class HSWalkThroughFourthScreen extends StatefulWidget {
  ...
  @override
  HSWalkThroughFourthScreenState createState() =>
      HSWalkThroughFourthScreenState();
}
...
class HSWalkThroughFourthScreenState extends State<HSWalkThroughFourthScreen> {
  ...
  Widget smartControlWidget(
      String icon, String title, String status, Widget cupertinoSwitch,
      {bool isTrue = false, bool isSizeBox = false}) {
    return Container(
      ...
      decoration: boxDecorationWithRoundedCorners(
        ...
        backgroundColor:
            appStore.isDarkModeOn ? appStore.cardColor : HS_colorPrimary,
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text("FEATURE 3/3",
            style: primaryTextStyle(size: 12, color: textSecondaryColorGlobal)),
        5.height,
        Text("Smart Control",
            style: primaryTextStyle(size: 28, weight: FontWeight.bold)),
        12.height,
        Text("You control all our Smart Home and enjoy Smart life",
            style: primaryTextStyle(size: 16, color: textSecondaryColorGlobal)),
        60.height,
        smartControlWidget(
          HS_notification,
          "Living room lamp",
