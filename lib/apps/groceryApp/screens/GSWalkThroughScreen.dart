...
class GSWalkThroughScreenState extends State<GSWalkThroughScreen>
    with AfterLayoutMixin<GSWalkThroughScreen> {
  ...
  void afterFirstLayout(BuildContext context) {
    pages = [
      gsWalkThroughWidget(gs_walk_through1,
          "Fresh groceries at your doorste\n in the next hour", "FIND FOOD"),
      gsWalkThroughWidget(gs_walk_through2,
          "Fresh groceries at your doorste\n in the next hour", "ADD ADDRESS"),
      gsWalkThroughWidget(gs_walk_through3,
