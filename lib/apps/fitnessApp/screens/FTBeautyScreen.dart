...
class _FTBeautyScreenState extends State<FTBeautyScreen> {
  ...
  void initState() {
    ...
    bList.add(FTBeautyEventModel(
      image:
          'https://i.pinimg.com/236x/b3/c3/16/b3c31620714b120fff3908bbd00e4111.jpg',
      name: 'OCEAN BEAUTY',
    ...
    bList.add(FTBeautyEventModel(
      image:
          'https://i.pinimg.com/originals/ab/39/3e/ab393e59e00c755940034913d452f096.jpg',
      name: 'MSMOF SPA',
      address: '44 Swanson Dr.Hamden',
      date: '5:30 am - 9:00 pm',
    ));
    bList.add(
      FTBeautyEventModel(
        image:
            'https://i.pinimg.com/originals/c0/8e/a1/c08ea199ab270e631b90f02ba75a289f.jpg',
    ...
    bList.add(
      FTBeautyEventModel(
        image:
            'https://i.pinimg.com/236x/65/49/10/654910ad0016f0f3cb01285f92221d18.jpg',
        name: 'CAPI SPA',
        address: '44 Swanson Dr.Hamden',
        date: '5:30 am - 9:00 pm',
      ),
  ...
  Widget _getFloatingActionButton() {
    return SpeedDialMenuButton(
      ...
      mainMenuFloatingActionButton: MainMenuFloatingActionButton(
          backgroundColor:
              appStore.isDarkModeOn ? Theme.of(context).cardColor : Colors.red,
          mini: false,
