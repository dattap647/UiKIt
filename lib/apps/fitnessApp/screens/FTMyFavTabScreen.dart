...
class _FTMyFavTabScreenState extends State<FTMyFavTabScreen> {
  ...
  void initState() {
    ...
    favList.add(FTFavouriteEventModel(
      image:
          'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmCFJDKw_8XXk2t-AFo6CCfpdJhgMvHc_pMg&usqp=CAU',
      name: 'OCEAN BEAUTY',
      address: '44 Swanson Dr.Hamden',
      date: '5:30 am - 9:00 pm',
    ));
    ...
    favList.add(FTFavouriteEventModel(
      image:
          'https://i.pinimg.com/236x/5a/88/56/5a8856a07b07a734a500be2d42eaae41.jpg',
      name: 'BLUEBIRD SPA',
      address: '44 Swanson Dr.Hamden',
      date: '5:30 am - 9:00 pm',
    ));
