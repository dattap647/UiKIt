...
class RHRoomDetailsScreenState extends State<RHRoomDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor:
            appStore.isDarkModeOn ? scaffoldColorDark : appBarBackgroundColor,
        elevation: 0,
        leading: IconButton(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                24.height,
                Text("430.522 USD/unit",
                    style: boldTextStyle(color: appPrimaryColor, size: 14)),
                8.height,
                Row(
                  children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                  children: [
                    settingAvailabilityWidget(
                        RH_brightness_icon, "0.14", Colors.pink),
                    settingAvailabilityWidget(
                        RH_water_drop_icon, "1.54", Colors.blue),
                    settingAvailabilityWidget(
                        RH_delivery_bike, "Free", Colors.greenAccent),
                    settingAvailabilityWidget(
                        RH_wifi_icon, "5.1", Colors.orangeAccent),
                  ],
                ),
                8.height,
                Row(
                  ...
                  children: [
                    settingAvailabilityWidget(
                        RH_watchman_icon, "Free", Colors.purple),
                    settingAvailabilityWidget(
                        RH_fridge_icon, "1.8", Colors.yellowAccent),
                    settingAvailabilityWidget(RH_tv_icon, "Free", Colors.grey),
                    settingAvailabilityWidget(RH_ait_conditioner_icon, "6.1",
      ...
      children: [
        Container(
          ...
          decoration: boxDecorationWithRoundedCorners(
              borderRadius: radius(12), backgroundColor: color),
