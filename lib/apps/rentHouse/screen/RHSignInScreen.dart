                          ...
                          child: Column(
                            children: [
                              ...
                              AppButton(
                                ...
                                child: Text('Sign In',
                                    style:
                                        boldTextStyle(size: 14, color: white)),
                                onTap: () {
                                  finish(context);
                              ...
                              Row(
                                ...
                                children: [
                                  Image.asset(RH_fb_icon,
                                      height: 40, width: 40),
                                  12.width,
                                  Image.asset(RH_twitter_icon,
                                      height: 40, width: 40),
                                  12.width,
                                  Image.asset(RH_google_plus_icon,
                                      height: 40, width: 40),
                                ],
                              )
                            ],
